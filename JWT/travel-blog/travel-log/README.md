...
## Uruchomienie (wymaga też działającej aplikacji Express na porcie 4000)
...
Przy uruchamianiu w Dockerze komponent serwerowy `/artykuly-z-api` może użyć dodatkowej zmiennej `API_INTERNAL_URL`, np. `http://api:4000`. Kod kliencki w przeglądarce dalej korzysta z `NEXT_PUBLIC_API_URL=http://localhost:4000`.
